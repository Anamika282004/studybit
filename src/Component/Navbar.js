      ...
      <div class="flex items-center justify-between text-blue-gray-900">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-x-1">
            <button class="hidden px-4 w-20 py-2 font-sans text-xs font-bold text-center text-gray-900 uppercase align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
